...
from src.model import Cliente, Pedido, Produto
...
class Header(ctk.CTkFrame):
    def __init__(self, master, systemroot: SystemRoot, **kwargs):
        ...
        self.__menu_frame = MenuSideBar(self.master, systemroot, fg_color="#272727", corner_radius=0)
